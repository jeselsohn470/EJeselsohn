...
public class Message {
    ...
    public boolean equals(Object o) {
        ...
        return senderPort == message.senderPort &&
                receiverPort == message.receiverPort &&
                requestID == message.requestID &&
                messageType == message.messageType &&
                Objects.equals(senderHost, message.senderHost) &&
                Objects.equals(receiverHost, message.receiverHost) &&
                Arrays.equals(contents, message.contents) &&
                Arrays.equals(networkPayload, message.networkPayload);
    }

    @Override
    public int hashCode() {
        int result = Objects.hash(messageType, senderHost, senderPort, receiverHost, receiverPort, requestID);
        result = 31 * result + Arrays.hashCode(contents);
        result = 31 * result + Arrays.hashCode(networkPayload);
        return result;
    }
}